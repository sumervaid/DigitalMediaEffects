...
mlm_data$home_social<-ifelse(grepl("1|2|3|5", mlm_data$place), 1, 
                                        (ifelse(grepl("7", mlm_data$place), 0, NA)))
...
mlm_data$home_public<-ifelse(grepl("4|6|8|9|10", mlm_data$place), 1, 
                                        (ifelse(grepl("7", mlm_data$place), 0, NA)))
...
mlm_data$home_nature<-ifelse(grepl("7", mlm_data$place), 0, 
                                        (ifelse(grepl("13", mlm_data$place), 1, NA)))
...
mlm_data$home_work<-ifelse(grepl("7", mlm_data$place), 0, 
                                        (ifelse(grepl("11", mlm_data$place), 1, NA)))

mlm_data$home_work<-factor(mlm_data$home_work)
mlm_data$home_work<-relevel(mlm_data$home_work, ref="0")
levels(mlm_data$home_work)

mlm_data$home_transit<-ifelse(grepl("7", mlm_data$place), 0, 
                                        (ifelse(grepl("12", mlm_data$place), 1, NA)))
...
select_vars<-mlm_data[,c("AngryTrait", "WorriedTrait", "HappyTrait", "SadTrait", "EnthuTrait", "RelaxedTrait")]
...
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day) %>%
  na.omit()
...
main_effect_random_sm<-lmer(wellbeing ~ 1 +
                  ...
                  surveys_per_id.z+
                    lagDur.cz*laggedWB.cz+overall_study_day+
                  (1+MediaUse| id),  na.action = na.exclude, data=mainEffect,
...
baseline_personality_sm<-lmer(wellbeing ~ 1 +
                             ...
                             lagDur.cz*laggedWB.cz+
                             MediaUse+
                             (1+MediaUse| id),  na.action = na.exclude, data=mainEffectPersonality,
                           REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
...
```{r}
mainEffectPersonality<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, extraversion.z) %>%
  na.omit()
...
```{r}
mainEffectPersonality<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, openness.z) %>%
  na.omit()
...
```{r}
mainEffectPersonality<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, neuroticism.z) %>%
  na.omit()
...
```{r}
mainEffectPersonality<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, agreeableness.z) %>%
  na.omit()
...
```{r}
mainEffectPersonality<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, conscientiousness.z) %>%
  na.omit()
...
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, trait_wellbeing.z, socialConnectedness.z, cesd.z, swls_sum.z, uls_mean.z) %>%
  na.omit()
```
...
baseline_wellbeing_sm<-lmer(wellbeing ~ 1 + demog_sex_recoded+    
                                   ...
                                   lagDur.cz*laggedWB.cz+
                                   MediaUse+
                                   (1+MediaUse| id),  na.action = na.exclude, data=mainEffectWellbeing,
                                 REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
...
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, trait_wellbeing.z) %>%
  na.omit()
...
```{r}
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse,  demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, socialConnectedness.z) %>%
  na.omit()
...
socialConnectedness_sm<-lmer(wellbeing ~ 1 + demog_sex_recoded+    
                           ...
                           nAct.cz+
                           lagDur.cz*laggedWB.cz+
                           MediaUse*socialConnectedness.z+
                           (1+MediaUse| id),  na.action = na.exclude, data=mainEffectWellbeing,
                         REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
...
```{r}
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse,  demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, cesd.z) %>%
  na.omit()
...
```{r}
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse,  demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, swls_sum.z) %>%
  na.omit()
...
```{r}
mainEffectWellbeing<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse,  demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, uls_mean.z) %>%
  na.omit()
...
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_social) %>%
  na.omit()
...
home_social_duration<-lmer(wellbeing ~ 1 +
                       ...
                       nAct.cz+
                       lagDur.cz*laggedWB.cz+
                       socialmedia.cz*home_social+
                   (1+socialmedia.cz| id),  na.action = na.exclude, data=mainEffect,
                 REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
summary(home_social_duration)

library(effects)
ef9<-effect(term="socialmedia.cz*home_social", mod=home_social_duration, xlevels=list(socialmedia.cz=c(-3, 3), home_social=c(0, 1)))

preddatahome_work<-as.data.frame(ef9)
preddatahome_work$home_social<-as.character(preddatahome_work$home_social)
ggplot(data=preddatahome_work, aes(x=socialmedia.cz, y=fit, linetype=as.character(home_social))) + 
  geom_point() +
  geom_line() +
  ...
  ylab("Predicted Affective Wellbeing") + ylim(2.5,3.5) +
  ggtitle("Moderating Role of home_social") + labs(colour="home_social")
```

```{r}
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_nature) %>%
  na.omit()
...
home_nature_sm<-lmer(wellbeing ~ 1 +
                       ...
                       nAct.cz+
                       lagDur.cz*laggedWB.cz+
                       MediaUse*home_nature+
                       (1+MediaUse| id),  na.action = na.exclude, data=mainEffect,
                           REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
summary(home_nature_sm)

mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_nature) %>%
  na.omit()
...
```{r}
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_transit) %>%
  na.omit()
...
home_transit_sm<-lmer(wellbeing ~ 1 +
                       ...
                       nAct.cz+
                       lagDur.cz*laggedWB.cz+
                       MediaUse*home_transit+
                      (1+MediaUse| id),  na.action = na.exclude, data=mainEffect,
                           REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
summary(home_transit_sm)

mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_transit) %>%
  na.omit()
...
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, home_work) %>%
  na.omit()
...
```{r}
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, MediaUse, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, ties_num) %>%
  na.omit()
...
control_ties_num_sm<-lmer(wellbeing ~ 1 +
                            ...
                            surveys_per_id.z+
                            lagDur.cz*laggedWB.cz+
                            MediaUse+(1+MediaUse| id), na.action=na.exclude, data=mainEffect, 
                          REML=TRUE, control=lmerControl(optimizer="Nelder_Mead"))

ties_num_sm<-lmer(wellbeing ~ 1 +
                       demog_sex_recoded+ 
                       demog_age.z+
                       overall_study_day+
                       weekend+
...
mainEffect<-main_effect_updated %>%
  dplyr::select(id, wellbeing, demog_age.z, socialmedia.cz, demog_sex_recoded, weekend, nAct.cz, surveys_per_id.z, lagDur.cz, laggedWB.cz, overall_study_day, ties_num) %>%
  na.omit()
...
ties_num_duration<-lmer(wellbeing ~ 1 +
                       demog_sex_recoded+ 
                       demog_age.z+
                       overall_study_day+
                       weekend+
                       ...
                       surveys_per_id.z+
                       lagDur.cz*laggedWB.cz+
                       socialmedia.cz*ties_num+
                           (1+socialmedia.cz| id),  na.action = na.exclude, data=mainEffect,
                         REML = TRUE, control = lmerControl(optimizer ="Nelder_Mead"))
summary(ties_num_duration)
```
...
predLabels=c("Intercept",
             ...
             "Duration Since Last EMA x Wellbeing at t-1", 
             "Social Media Use (vs. Non-Use) x Distant Tie (vs Alone)",
             "Social Media Use (vs. Non-Use) x Close Tie (vs Alone)")

dvLabels=c("Baseline Model",
           "Tie Strength of Interaction Partners (vs Alone)")
...
predLabels=c("Intercept",
             ...
             "Distant Tie Interaction Partner",
             "Duration Since Last EMA x Wellbeing at t-1", 
             "Social Media Use Duration x Distant Tie (vs Alone)",
             "Social Media Use Duration x Close Tie (vs Alone)")
