...
library(lubridate)
library(jtools)
setwd("/Volumes/GoogleDrive/My Drive/Social Media Sensitivity Confirmatory Analyses/Data Prep - Preregistration - Spring ")
ema_long<-read.csv("04_ema_survey_coco_ut2.csv")
demogPers<-read_csv("/Volumes/GoogleDrive/My Drive/Social Media Sensitivity Confirmatory Analyses/Data Preprocessing - Confirmatory /DemogPersSpring.csv")
presurvey<-read_csv("01_presurvey_coco_ut2.csv")
personality<-read_csv("/Volumes/GoogleDrive/My Drive/Social Media Sensitivity Confirmatory Analyses/Data Preprocessing - Confirmatory /bfi_spring.csv")
demogPers$X1<-NULL
```
...
#write.csv(main_effect_updated,file="modelling_data_exploratory_confirmatory.csv")
```
